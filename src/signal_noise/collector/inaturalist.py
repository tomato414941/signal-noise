...
INATURALIST_SERIES: list[tuple[str, str | None, str, str, str]] = [
    ...
    (
        "observations",
        "Actinopterygii",
        "inaturalist_observations_fish",
        "iNaturalist Fish Observations",
        "wildlife",
    ),
    (
        "observations",
        "Fungi",
        "inaturalist_observations_fungi",
        "iNaturalist Fungi Observations",
        "biodiversity",
    ),
    (
        "observations",
        "Mollusca",
        "inaturalist_observations_mollusks",
        "iNaturalist Mollusk Observations",
        "biodiversity",
    ),
    (
        "observations",
        "Arachnida",
        "inaturalist_observations_arachnids",
        "iNaturalist Arachnid Observations",
        "biodiversity",
    ),
    (
    ...
    (
        "observations/species_counts",
        "Fungi",
        "inaturalist_species_fungi",
        "iNaturalist Fungi Species Count",
        "biodiversity",
    ),
    (
        "observations/species_counts",
        "Aves",
        "inaturalist_species_birds",
        "iNaturalist Bird Species Count",
        "biodiversity",
    ),
    (
        "observations/species_counts",
        "Mammalia",
        "inaturalist_species_mammals",
        "iNaturalist Mammal Species Count",
        "biodiversity",
    ),
]
